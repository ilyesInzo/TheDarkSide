 ...
 *
 * @param actor5 Xpos
 * @desc X position formula of actor5's center. 
 * (default:600 + 32 * 4) =728
 * @type text
 * @default 600 + 32 * 4
 *
 * @param actor5 Ypos
 * @desc Y position formula of actor5's bottom. 
 * (default:280 + 48 * 4) =472
 * @type text
 * @default 280 + 48 * 4
 *
 * @param actor6 Xpos
 * @desc X position formula of actor6's center. 
 * (default:600 + 32 * 5) =760
 * @type text
 * @default 600 + 32 * 5
 *
 * @param actor6 Ypos
 * @desc Y position formula of actor6's bottom. 
 * (default:280 + 48 * 5) =520
 * @type text
 * @default 280 + 48 * 5
 * 
 * @command set
...
(() => {
  ...
  let SVActorX = new Array(6);
  let SVActorY = new Array(6);
  ...
  SVActorX[4] = eval(parameters['actor5 Xpos'] || '728');
  SVActorX[5] = eval(parameters['actor6 Xpos'] || '760');
  ...
  SVActorY[4] = eval(parameters['actor5 Ypos'] || '472');
  SVActorY[5] = eval(parameters['actor6 Ypos'] || '520');
  ...
  Game_System.prototype.defineSvActorArray = function() {
    this.svActorX = new Array(6);
    this.svActorY = new Array(6);
  };
