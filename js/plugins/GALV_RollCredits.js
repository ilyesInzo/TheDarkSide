...
Window_Credits.prototype.standardPadding = () => {
	return 18;
}
Window_Credits.prototype.textPadding = () => {
	return 6;
}
...
// ADD TO TITLE
var visustellaCorePlugin = this.$plugins.filter((plugin) => { return plugin.name == "VisuMZ_0_CoreEngine" });
// with visustella you don't need that code
// you have to add to configure the commande in the plugin ( Title list commande)
// {"Symbol:str":"test","TextStr:str":"Untitled","TextJS:func":"\"return 'credit';\"","ShowJS:func":"\"return true;\"","EnableJS:func":"\"return true;\"","ExtJS:func":"\"return null;\"","CallHandlerJS:func":"\"Galv.CRED.start(\\\"Credits\\\")\\n\""}
//where credit is the fileName
if (visustellaCorePlugin.length == 0) {
